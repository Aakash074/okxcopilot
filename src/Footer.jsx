...
function Footer() {
  return (
    <footer className="w-full bg-gray-100 border-t py-4 px-4 flex flex-col items-center gap-2 mt-8">
      ...
      <div className="text-xs text-gray-500">&copy; {new Date().getFullYear()} OKX Copilot. All rights reserved.</div>
    </footer>
  );
}
